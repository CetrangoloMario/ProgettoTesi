...
public class Test {
    ...
    private final String PATH_DATA = "D:/cetra/Deskstop/secure/secure-jpeg-masking-master.zip_expanded/secure-jpeg-masking-master/data";
    private final String PATH_SCRIPT = "D:/cetra/Deskstop/secure/secure-jpeg-masking-master.zip_expanded/secure-jpeg-masking-master/script";
    ...
    public void execPythonScript(String script, String file, String coords, String passw) throws IOException {
        String[] args = new String[] { "C:\\Users\\cetra\\anaconda3\\envs\\new\\python", script, file, coords, passw };
    ...
    public void writeResults(String img, ArrayList<String> results, String type, String cipher, String mode, boolean first, boolean last) throws IOException {
        File file = new File(PATH_DATA + "/results/resultsgruppo40.txt");
        if(!file.exists()){
            file.createNewFile();
        }
